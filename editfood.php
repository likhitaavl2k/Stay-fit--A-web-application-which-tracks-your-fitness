...
$query = "UPDATE FOODTABLE SET NAME='$name' ,DESCRIPTION='$description',WEIGHT='$weight',CATEGORY='$category' WHERE ID='$id'";
$set=mysqli_query($con,$query);

if(!empty($smallfile)){
	$query1 = "UPDATE FOODTABLE SET SMALL_PIC='$smallfile',SMALL_TYPE='$smalltype' WHERE ID='$id'";
	mysqli_query($con,$query1);
}

if(!empty($largefile)){
	$query2 = "UPDATE FOODTABLE SET LARGE_PIC='$largefile', LARGE_TYPE='$largetype' WHERE ID='$id'";
