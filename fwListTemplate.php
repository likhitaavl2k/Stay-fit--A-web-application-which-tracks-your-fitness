      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <div class="form-group ">
            ...
            <input type="file" class="form-control-file" name="file1" accept="image/png, image/jpeg">
              <!-- <img src="images/upload.svg">
              <label for="largefile" style="color: black;"><b>Upload large picture:</b></label>
              <input type="file" class="form-control-file" name="largefile" accept="image/png, image/jpeg"> -->
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-outline-primary" data-dismiss="modal" id="close">Close</button>
            <button  class="btn btn-primary"  name="id" id="add">ADD</button>
          </div>
        </form>
      </div>
    </div>
      ...
      <form action="insertWorkouts.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="form-group ">
            ...
            <input type="file" class="form-control-file" name="file1" accept="image/png, image/jpeg">
              <!-- <img src="images/upload.svg">
              <label for="largefile" style="color: black;"><b>Upload GIF:</b></label>
              <input type="file" class="form-control-file" name="largefile" accept="image/gif"> -->
              <img src="images/upload.svg" style="position: absolute;left: 50%;top: 79%;">
