...
<body>
  ...
  <div class="navbar navbar-dark bg-dark shadow-sm"  style="position: sticky;">
    <div class="container d-flex justify-content-between">
      ...
      <a href="workoutmain-weightPremi.php" class="navbar-brand d-flex align-items-center">
                      ...
                      <footer class="text-muted">
                        <div class="container" >
                          <p class="float-right" >
                            ...
                            <!-- <button id="chatbot" title="chat bot" style="position: absolute;bottom: 100px;">chat</button> -->
                          </p>
