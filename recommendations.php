...
if(!isset($_SESSION['email']))
	header("Location: userlogin.php");//arey ne ipde vastha 1 min wokayy liki
				...
				<div class="col-md-4 gallery ">
					<div class="card mb-4 shadow-sm " >
						<a href="<?php echo 'data:'.$result['large_type'].';base64,'.base64_encode($result['large_pic'])  ?>" data-lightbox="mygallery" data-title="<?php  echo $result['name']  ?>">
							<img src="<?php echo 'data:'.$result['small_type'].';base64,'.base64_encode($result['small_pic'])  ?>" width="100%" ></a>
