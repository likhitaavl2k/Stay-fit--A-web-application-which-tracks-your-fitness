...
<main role="main">
  ...
  <section class="jumbotron text-center;" style="background-image: url(images/foodrecom.jpg);height: 400px;">
    <div class="container">
      <p style="color: black;font-family: cursive;font-size: 50px;position: absolute;left: 20%;top: 48%;">Welcome to our food</p>
      <p style="color: black;font-family: cursive;font-size: 50px;position: absolute;left: 20%;top: 58%;">recommendations!!</p>
    ...
    <div style="position: absolute;left: 20%;top: 80%;">
      <form action="StoreWeightInCookie_Premifood.php" method="post">
...
<footer class="text-muted">
  <div class="container">
    <!-- <p class="float-right">
      <a href="foodmain-weight.php">Back to top</a>
    </p> -->
