...
<body>
    <header style="background-color: black;position: relative;">
        <a href="exerciseportal.html"><i class="fa fa-home fa-4x" style="position: relative;left: 0;top: 0;"></i></a>
    ...
    <div style="background-color: black;height: 250px;">
        ...
        <!-- <p style="position: absolute;left: 5%;top: 40%;"> -->
        <!-- style="color: black;font-family: cursive;font-size: 25px;font-weight: 550;" -->
    </div>
    <br><br>
